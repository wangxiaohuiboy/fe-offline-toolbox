...
| 工具 | 说明 |
|------|------|
| **翻译** | 双引擎完全离线：**① 词典直译**——7.7 万中文词条（团队精编 1270+ 条 + [ECDICT](https://github.com/skywind3000/ECDICT) 扩充词典），术语准、速度快；**② 神经整句翻译**——内置本地 AI 模型 opus-mt-zh-en（Transformers.js + WASM，约 110MB），语句自然通顺，首次加载模型约 10-30 秒，之后秒开。中英双向；支持配置公司内网翻译接口 |
