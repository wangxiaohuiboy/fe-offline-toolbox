...
| 工具 | 说明 |
|------|------|
| **翻译** | 内置 **1.7 万+ 中文词条**离线词典（团队精编术语 1240+ 条 + 基于 [ECDICT](https://github.com/skywind3000/ECDICT) 的扩充词典），中英双向；含日常口语与礼貌用语整句短语（如「很高兴见到你」→ nice to meet you）；未收录词**原样保留并提示命中率**（不输出拼音）；支持配置公司内网翻译接口 |
